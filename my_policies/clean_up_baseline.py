...
class CleanUpPolicy(policy.Policy):
  ...
  def __init__(self, policy_id: str) -> None:
    ...
    substrate_ckpt = 'clean_up/PPO_meltingpot_fa1ae_00000_0_2023-08-29_18-46-02/checkpoint_000001/'
  ...
  def step(self, timestep: dm_env.TimeStep,
    ...
    """See base class."""
    _IGNORE_KEYS = ['WORLD.RGB', 'NUM_OTHERS_WHO_CLEANED_THIS_STEP']
    observations = {
        key: value
